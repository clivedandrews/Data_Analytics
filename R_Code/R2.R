...
letters # prints lower case letters
LETTERS # prints upper case letters
...
# Function
# Functions are of 2 types i.e., in-built functions and user-defined functions
# Functions are called modular which helps avoid repeating of codes
...
data = read.csv(file.choose("C:/Users/Office/Documents/myProjects/Data_Analytics/R/cars.csv"))
View(data)
summary(data)
